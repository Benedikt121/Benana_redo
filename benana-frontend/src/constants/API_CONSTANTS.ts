...
export const SPOTIFY_UNLINK_PATH = `${ME_PATH}/spotify`;
export const APPLE_UNLINK_PATH = `${ME_PATH}/apple`;
...
export const SPOTIFY_REFRESH_PATH = `${SPOTIFY_PATH}refresh`;
export const SPOTIFY_CURRENT_PATH = `${SPOTIFY_PATH}current`;
export const SPOTIFY_PLAY_PATH = `${SPOTIFY_PATH}play`;
export const SPOTIFY_RESUME_PATH = `${SPOTIFY_PATH}resume`;
export const SPOTIFY_PAUSE_PATH = `${SPOTIFY_PATH}pause`;
export const SPOTIFY_NEXT_PATH = `${SPOTIFY_PATH}next`;
export const SPOTIFY_PREVIOUS_PATH = `${SPOTIFY_PATH}previous`;
export const SPOTIFY_SHUFFLE_PATH = `${SPOTIFY_PATH}shuffle`;
export const SPOTIFY_REPEAT_PATH = `${SPOTIFY_PATH}repeat`;
export const SPOTIFY_PLAYLISTS_PATH = `${SPOTIFY_PATH}playlists`;
export const SPOTIFY_PLAY_PLAYLIST_PATH = `${SPOTIFY_PATH}play-playlist`;
